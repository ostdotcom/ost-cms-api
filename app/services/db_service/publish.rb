module DbService
  class Publish < Base
    ...
    def handle_data
      ...
      drafted_entities = EntityDataVersion.where(entity_id: @entity.id, status:GlobalConstant::Models::EntityDataVersion.draft)
      if entity_status == GlobalConstant::Models::Entity.previewed
        ...
        return success
      elsif entity_status == GlobalConstant::Models::Entity.published || (entity_status == GlobalConstant::Models::Entity.draft && drafted_entities.count == 0)
